...
// Insert an element
CircularLinkList.prototype.add = function(data) {
...
CircularLinkList.prototype.insertAt = function(data,pos) {
...
// Remove a node
CircularLinkList.prototype.removeAt = function(pos)  {
...
// Print list 
CircularLinkList.prototype.print = function() {
...
// Print list size
CircularLinkList.prototype.getSize = function() {
    let curr = this.head;
    let n = 0;
    if(curr){
